...
$videos = $files | Where-Object { $_.Name -like "*.mkv" -or $_.Name -like "*.mp4" } | Sort-Object { $_.Name };

$subtitles =$files | Where-Object { $_.Name -like "*.srt" -or $_.Name -like "*.ass" } | Sort-Object { $_.Name };
